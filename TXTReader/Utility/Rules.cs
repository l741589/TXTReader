...
namespace TXTReader.Utility {
    ...
    class Rules : DependencyObject {
        ...
        public static readonly DependencyProperty IsListEnableProperty = DependencyProperty.Register("IsListEnable", typeof(bool), typeof(Rules), new PropertyMetadata(true));
        public static readonly DependencyProperty IsTreeEnableProperty = DependencyProperty.Register("IsTreeEnable", typeof(bool), typeof(Rules), new PropertyMetadata(false));
        public static readonly DependencyProperty ListTextProperty = DependencyProperty.Register("ListText", typeof(String), typeof(Rules));
        public static readonly DependencyProperty TreeTextProperty = DependencyProperty.Register("TreeText", typeof(ObservableCollection<String>), typeof(Rules));
        ...
        public static readonly DependencyProperty ListSelectedIndexProperty = DependencyProperty.Register("ListSelectedIndex", typeof(int), typeof(Rules), new PropertyMetadata(0, 
        (d, e) => {
            Rules o = d as Rules;
        ...
        public static readonly DependencyProperty TreeSelectedIndexProperty = DependencyProperty.Register("TreeSelectedIndex", typeof(int), typeof(Rules), new PropertyMetadata(0,
        (d, e) => {
            Rules o = d as Rules;
