...
namespace Zlib.Text {
    public delegate void ParserNodeCallback(XmlNode n);
    public delegate Parser.Writer ParserWriterCallback(Parser.Writer w);
    public delegate Parser.Reader ParserReaderCallback(Parser.Reader r);
    public class Parser {
