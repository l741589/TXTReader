...
namespace Zlib.Text
{
    public static class XHtmlTools
    {
        ...
        /// <returns></returns>
        public static XmlDocument GetXmlDocument(byte[] html) { return GetXmlDocument(html, Encoding.Default); }
        public static XmlDocument GetXmlDocument(byte[] html, Encoding encoding) { return GetXmlDocument(encoding.GetString(html)); }
        public static XmlDocument GetXmlDocument(String html) {
            ...
            try {
                ...
                File.WriteAllText(@"E:/a.txt", xml);
                xml = string.Format("{0}{1}", XMLHEAD.ToString(), xml);
                //File.WriteAllText(@"E:/a.txt", xml);
                xmlDoc.LoadXml(xml);
        ...
        /// <param name="html"></param>
        /// <returns></returns>
        public static string Convert(byte[] html) { return Convert(html, Encoding.Default); }
        public static string Convert(byte[] html, Encoding encoding) { return Convert(encoding.GetString(html)); }
        public static string Convert(String html) {
            string xml = string.Empty;
            try {
                using (HtmlReader reader = new HtmlReader(html)) {
