...
namespace TRContent.Rules {
    ...
    public class Rule : DependencyObject {
        ...
        public static Rule Instance { get { if (instance == null) instance = new Rule(); return instance; } }
        

        private ZME treeTrmex = null;
        private ZME listTrmex = null;
        ...
        public ZME ListTrmex { get { if (listTrmex != null) return listTrmex; else  return listTrmex = ZME.Compile(ListRule); } set { listTrmex = value; } }
        public ZME TreeTrmex { get { if (treeTrmex != null) return treeTrmex; else  return treeTrmex = ZME.Compile(TreeRule); } set { treeTrmex = value; } }
